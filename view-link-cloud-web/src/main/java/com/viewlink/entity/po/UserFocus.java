...
public class UserFocus implements Serializable {
	...
	public String toString (){
		return "用户ID:"+(userId == null ? "空" : userId)+"，关注用户ID:"+(focusUserId == null ? "空" : focusUserId)+"，关注时间:"+(focusTime == null ? "空" : DateUtil.format(focusTime, DateTimePatternEnum.YYYY_MM_DD_HH_MM_SS.getPattern()));
	}
}
