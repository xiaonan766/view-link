...
public class StatisticsInfo implements Serializable {
	...
	public String toString (){
		return "统计日期:"+(statisticsDate == null ? "空" : statisticsDate)+"，用户ID:"+(userId == null ? "空" : userId)+"，数据统计类型:"+(dateType == null ? "空" : dateType)+"，统计数量:"+(statisticsCount == null ? "空" : statisticsCount);
	}
}
