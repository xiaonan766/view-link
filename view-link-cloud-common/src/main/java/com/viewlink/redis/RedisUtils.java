...
public class RedisUtils<V> {
    ...
    public Map<String, V> getBatch(String keyPrifix) {
        //获取Redis中所有以 keyPrifix开头的键，返回一个 Set<String> 集合，集合中的元素是符合条件的键。
        Set<String> keySet = redisTemplate.keys(keyPrifix + "*");
        List<String> keyList = new ArrayList<>(keySet);
        //批量获取keyList中所有键对应的值，返回一个 List<V> 类型的列表，列表中的元素顺序与 keyList 中键的顺序一一对应
    ...
    public Long executeLongScript(String script, List<String> keys, String... args) {
