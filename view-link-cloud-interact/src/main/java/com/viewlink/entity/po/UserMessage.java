...
public class UserMessage implements Serializable {
	...
	* 用户视频相关*/
	...
	public UserMessageExtendDTO getExtendDto() {
		//判断extendJson中是否有内容，无则返回一个空的UserMessageExtendDTO，有则将json转化为dto
